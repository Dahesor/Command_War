...
$execute if data storage ram listbc[0].void run return run loot replace block ~ ~ ~ container.$(slot) loot cmd:background
$execute unless data storage ram listbc[0].id run return run item replace block ~ ~ ~ container.$(slot) with air
...
$loot replace block ~ ~ ~ container.$(slot) loot registry:bc
$item modify block ~ ~ ~ container.$(slot) cmd:in_ui